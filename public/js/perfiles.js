...
window.App.perfiles.hematologia_completa = {
    ...
    area: 'Hematología',
    examenes: [
        { id: 'globulos_blancos', nombre: 'Glóbulos Blancos', area: 'Hematología', unidad: 'x10³/µL', refMin: 4.0, refMax: 10.0, grupo: 'Absolutos' },
        ...
        { id: 'globulos_rojos', nombre: 'Glóbulos Rojos', area: 'Hematología', unidad: 'x10⁶/µL', refMin: 4.5, refMax: 5.5, grupo: 'Hemograma' },
        { id: 'hemoglobina', nombre: 'Hemoglobina', area: 'Hematología', unidad: 'g/dL', refMin: 12.0, refMax: 18.0, refTexto: 'F: 12.0-16.0; M: 13.0-18.0', grupo: 'Hemograma' },
        { id: 'hematocrito', nombre: 'Hematocrito', area: 'Hematología', unidad: '%', refMin: 38.0, refMax: 54.0, grupo: 'Hemograma' },
        { id: 'vcm', nombre: 'V.C.M.', area: 'Hematología', unidad: 'fL', refMin: 80, refMax: 100, grupo: 'Hemograma' },
        { id: 'hcm', nombre: 'H.C.M.', area: 'Hematología', unidad: 'pg', refMin: 26, refMax: 34, grupo: 'Hemograma' },
        { id: 'chcm', nombre: 'C.H.C.M.', area: 'Hematología', unidad: 'g/dL', refMin: 32, refMax: 36, grupo: 'Hemograma' },
        { id: 'rdw_cv', nombre: 'RDW-CV', area: 'Hematología', unidad: '%', refMin: 0, refMax: 15.1, refTexto: '<15.1', grupo: 'Hemograma' },
        { id: 'plaquetas', nombre: 'Plaquetas', area: 'Hematología', unidad: 'x10³/µL', refMin: 150, refMax: 450, grupo: 'Hemograma' },
        { id: 'vpm', nombre: 'V.P.M.', area: 'Hematología', unidad: 'fL', refMin: 6.5, refMax: 13.5, grupo: 'Hemograma' },
        { id: 'pdw', nombre: 'P.D.W.', area: 'Hematología', unidad: '%', refMin: 0, refMax: 16.8, refTexto: '<16.8', grupo: 'Hemograma' },
        { id: 'plcr', nombre: 'P.LCR', area: 'Hematología', unidad: '%', refMin: 0, refMax: 42.3, refTexto: '<42.3', grupo: 'Hemograma' },
        { id: 'vsg', nombre: 'V.S.G. 1 Hora', area: 'Hematología', unidad: 'mm/h', refMin: 3, refMax: 20, refTexto: 'Niño: 3 - 13 mm/h | Mujer: < 20', grupo: 'Hemograma' }
    ]
};
